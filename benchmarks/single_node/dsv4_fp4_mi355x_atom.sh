...
if [ "${AITER_DSV4_PR2998:-1}" = "1" ]; then
    ...
    AITER_PR2998_SHA=${AITER_PR2998_SHA:-479e61d590082b3ce1474af7a4cd55118bb8eee9}
...
if [ "${ATOM_DSV4_PR650:-1}" = "1" ]; then
    ...
    ATOM_PR650_SHA=${ATOM_PR650_SHA:-13594d48c8c6e1d558b1b713ce4eb35038e50380}
...
if [ "${EVAL_ONLY}" = "true" ]; then
    ...
    export AITER_DSV4_MOE_CANARY="${AITER_DSV4_MOE_CANARY:-1}"
    echo "DSv4 AITER MoE trace: topk1=${AITER_DSV4_MOE_DETERMINISTIC_TOPK1}, stage2_set_topk1=${AITER_DSV4_MOE_STAGE2_SET_TOPK1}, trace_set=${AITER_DSV4_MOE_TRACE_SET}, row_check=${AITER_DSV4_MOE_ROW_CHECK}, canary=${AITER_DSV4_MOE_CANARY}"
    ...
    if [ "${ATOM_DSV4_PREFILL_DIAG_ENABLE:-1}" = "1" ]; then
        ...
        export ATOM_DSV4_PREFILL_DIAG_MOE_REPEAT_MS="${ATOM_DSV4_PREFILL_DIAG_MOE_REPEAT_MS:-1,2,4,8,16,32,64,127,128,129,256}"
        export ATOM_DSV4_PREFILL_DIAG_MOE_ROW_SERIAL="${ATOM_DSV4_PREFILL_DIAG_MOE_ROW_SERIAL:-1}"
        ...
        echo "DSv4 prefill diagnostics enabled: layers=${ATOM_DSV4_PREFILL_DIAG_LAYERS}, deep_layers=${ATOM_DSV4_PREFILL_DIAG_DEEP_LAYERS}, sparse_layers=${ATOM_DSV4_PREFILL_DIAG_SPARSE_LAYERS}, moe_repeat_ms=${ATOM_DSV4_PREFILL_DIAG_MOE_REPEAT_MS}, moe_row_serial=${ATOM_DSV4_PREFILL_DIAG_MOE_ROW_SERIAL}, verbose=${ATOM_DSV4_PREFILL_DIAG_VERBOSE}"
    fi
fi
