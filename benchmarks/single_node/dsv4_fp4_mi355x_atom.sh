...
if [ "${AITER_DSV4_PR2998:-1}" = "1" ]; then
    ...
    AITER_PR2998_SHA=${AITER_PR2998_SHA:-a1019b4d3ac1a9101a6966010a1c0357663b37f0}
...
if [ "${ATOM_DSV4_PR650:-1}" = "1" ]; then
    ...
    ATOM_PR650_SHA=${ATOM_PR650_SHA:-a7c682698861ecc9d36345906b52206f05035121}
...
if [ "${EVAL_ONLY}" = "true" ]; then
    ...
    if [ "${ATOM_DSV4_PREFILL_DIAG_ENABLE:-1}" = "1" ]; then
        ...
        export ATOM_DSV4_PREFILL_DIAG_LAYERS="${ATOM_DSV4_PREFILL_DIAG_LAYERS:-all}"
        export ATOM_DSV4_PREFILL_DIAG_DEEP_LAYERS="${ATOM_DSV4_PREFILL_DIAG_DEEP_LAYERS:-0}"
        export ATOM_DSV4_PREFILL_DIAG_VERBOSE="${ATOM_DSV4_PREFILL_DIAG_VERBOSE:-1}"
        export ATOM_DSV4_PREFILL_DIAG_TOL="${ATOM_DSV4_PREFILL_DIAG_TOL:-1e-3}"
        export ATOM_DSV4_PREFILL_DIAG_SPARSE_COMPARE="${ATOM_DSV4_PREFILL_DIAG_SPARSE_COMPARE:-1}"
        export ATOM_DSV4_PREFILL_DIAG_SPARSE_LAYERS="${ATOM_DSV4_PREFILL_DIAG_SPARSE_LAYERS:-0}"
